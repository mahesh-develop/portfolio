      ...
      <div className='container mx-auto px-8 md:px-16 lg:px-24'>
        ...
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
          <img
            src={mahi}
            alt='Mahi'
            className='w-72 h-80 rounded-lg object-cover mb-8'
          />

          <div className='flex-1'>
            <p className='text-lg mb-8'>
              I am a passionate MERN Stack Developer with a focus on
              building modern and responsive web applications. With a strong
              foundation in both frontend and backend technologies, I strive
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center'>
                <label htmlFor='jsreact' className='w-2/12'>
                  JS & React JS
                </label>
                <div className='grow bg-gray-800 rounded-full h-2.5'>
                  <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full transform transition-transform duration-300 hover:scale-105 w-10/12'></div>
